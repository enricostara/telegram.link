...
Builder.prototype.require = function (module) {
    logger.debug('Require %s module: ', module);
...
Builder.prototype.requireFromRoot = function (module) {
    ...
    logger.debug('Require \'%s\' module with path \'%s\': ', module, modulePath);
...
Builder.prototype.buildTypeConstructor = function () {
    ...
    typeConstructor.logger = createLogger(this.module + '.' + this.tlSchema[typeNameProperty]);
