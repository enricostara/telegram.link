...
mtproto._classes = ['ResPQ', 'P_Q_inner_data', 'Server_DH_Params', 'Server_DH_inner_data'];

// Define the `static-method` list to build in module `mtproto`
mtproto._methods = ['req_pq', 'req_DH_params'];
...
//        this._messageId = '6063049213996957696';
        this._messageLength = this._message.length;
    }
    this._logger = require('./util/logger')('mtproto.PlainMessage');
};
