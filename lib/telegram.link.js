...
// This class represents the connection client to Telegram and implements the Telegram API.
...
Client.prototype.createAuthKey = function(callback) {
    ...
    if (this._connection && this._connection.isConnected()) {
        ...
        this.emit(exports.EVENT.ERROR,
            new Error("Client is not yet connected! Wait for a connection before call this method."));
    }
};
