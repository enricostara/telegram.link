...
//      - **lang** _(required)_: device/user language, see ISO 639-1
...
//      - **connectionType** _(optional)_: the value could be `HTTP` or `TCP`, HTTP is the default
